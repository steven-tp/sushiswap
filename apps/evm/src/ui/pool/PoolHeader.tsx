...
export const PoolHeader: FC<PoolHeader> = ({
  ...
  if (pool && token0 && token1)
    return (
      <div className="flex flex-col gap-6 border-neubrutal rounded-lg px-10 py-5 background-card">
        <div className="flex flex-col gap-4">
          <LinkInternal
            href={backUrl}
            className="flex items-center w-fit gap-0.5 leading-none hover:underline hover:text-hover dark:hover:text-hover font-black text-base font-display"
          >
          ...
          <div className="relative flex items-center gap-3 max-w-[100vh]">
            ...
            <Button
              ...
              className={typographyVariants({
                variant: 'h1',
                className:
                  'text-white sm:!text2-xl sm:!text-4xl !font-bold truncate overflow-x-auto',
              })}
            >
              <LinkExternal
            ...
            {pool instanceof SushiSwapV3Pool ? null : (
              <div
                className={classNames(
                  ...
                  'text-sm px-2 py-1 font-semibold leading-4 rounded-md mt-0.5',
                )}
              >
                {pool.protocol === 'SUSHISWAP_V3'
                  ? 'V3'
