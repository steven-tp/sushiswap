...
export const Hero: FC = () => {
  ...
  return (
    <section>
      <div className="dark:bg-[#1d2939] border-neubrutal py-5 px-10 rounded-lg flex flex-col justify-between gap-12 lg:flex-row lg:items-center mb-8">
        ...
        <div className="flex flex-col items-center gap-4 lg:items-end">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="452" height="279" viewBox="0 0 452 279" fill="none">
              ...
              <path d="M263.456 119.699L253.872 141.338C253.872 141.338 250.328 152.877 258.604 159.674L265.484 161.434L274.782 158.495L280.224 151.82L281.879 145.023L280.12 137.238L269.34 120.393L265.545 117.411L263.456 119.699Z" fill="#68FEFF"/>
              <path d="M284.773 100.306L280.51 109.929C280.51 109.929 278.933 115.061 282.616 118.087L285.675 118.867L289.817 117.558L292.234 114.584L292.971 111.559L292.191 108.091L287.399 100.601L285.709 99.2741L284.782 100.288L284.773 100.306Z" fill="#68FEFF"/>
              <path d="M254.834 81.415L251.498 88.9401C251.498 88.9401 250.268 92.9541 253.144 95.3208L255.536 95.9277L258.768 94.9047L260.657 92.5813L261.238 90.2145L260.623 87.5096L256.871 81.6491L255.553 80.6174L254.826 81.415H254.834Z" fill="#68FEFF"/>
              ...
              <path d="M57.4521 87.7697H50.6671V119.951H57.4521V87.7697Z" fill="#68FEFF" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
              ...
              <path d="M90.5456 78.1293H83.7605V120.211H90.5456V78.1293Z" fill="#68FEFF" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M106.594 90.674H99.809V120.211H106.594V90.674Z" fill="#68FEFF" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
              ...
              <path d="M138.7 76.8115H131.914V120.211H138.7V76.8115Z" fill="#68FEFF" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div className="flex flex-col sm:flex-row w-full sm:w-[unset] gap-4">
        <div className="flex w-1/2  border-neubrutal rounded-lg h-20">
          <Button
            asChild
            size="lg"
            className="px-6 font-display !bg-[#BFFCFB] text-lg !font-bold !text-black flex-1 w-full sm:flex-0 sm:w-[unset] rounded-md rounded-r-none !justify-between h-full"
          >
            <LinkInternal
              href={
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="134" height="94" viewBox="0 0 134 94" fill="none">
                ...
                <path d="M9.01702 85.2246C9.01702 85.2246 8.75307 83.2621 6.89688 81.5595C4.10409 78.9999 1.49295 80.1197 2.03504 82.2451C2.57998 84.3676 5.72754 84.7447 7.3737 84.9847L9.01986 85.2246H9.01702Z" fill="#93FBFA" stroke="#41341E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.2611 78.697C12.2611 78.697 12.4626 76.7287 14.262 74.9661C16.9697 72.3151 19.6177 73.3521 19.1409 75.4918C18.6669 77.6315 15.5307 78.1085 13.8959 78.4028L12.2611 78.697Z" fill="#93FBFA"/>
                ...
                <path d="M15.7776 68.6414C15.7776 68.6414 16.0841 65.6276 18.84 62.9309C22.9866 58.8743 27.0339 60.4598 26.3073 63.7364C25.5808 67.0131 20.7842 67.7444 18.2781 68.1929L15.7748 68.6443L15.7776 68.6414Z" fill="#93FBFA"/>
                ...
                <path d="M10.9556 83.502C10.9556 83.502 11.0861 82.2165 12.2611 81.0653C14.0293 79.3341 15.7578 80.0111 15.4484 81.4081C15.1391 82.805 13.0927 83.1164 12.0227 83.3106L10.9556 83.502Z" fill="#93FBFA" stroke="#41341E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M10.1835 78.917C10.1835 78.917 11.1967 76.9088 10.5524 74.1063C9.58462 69.8898 6.42003 69.2385 5.56289 71.581C4.70575 73.9235 7.4134 76.3231 8.79844 77.6201L10.1835 78.917Z" fill="#93FBFA" stroke="#41341E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.9678 71.5324C12.9678 71.5324 13.9214 69.7041 13.3679 67.1245C12.5307 63.2451 9.6357 62.6081 8.82114 64.7449C8.00658 66.8817 10.4588 69.1185 11.7133 70.3269L12.9678 71.5324Z" fill="#93FBFA" stroke="#41341E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button asChild size="lg" className="!bg-[#BFFCFB] !text-black border-l-2 border-black px-8 rounded-md rounded-l-none h-full">
        ...
        <div className='w-1/2 border-neubrutal rounded-lg h-20'>
          <Button
            ...
            variant="secondary"
            size="lg"
            className='px-6 font-display text-lg !font-bold dark:!text-white dark:!bg-[#1d2939] rounded-md !justify-between h-full'
          >
