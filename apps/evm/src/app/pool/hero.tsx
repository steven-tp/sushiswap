      ...
      <div className="flex flex-col sm:flex-row w-full sm:w-[unset] gap-4">
        <div className="flex w-1/2  border-neubrutal rounded-lg h-20">
          <Button
            asChild
            size="lg"
            className="px-6 font-display !bg-hover text-lg !font-bold !text-black flex-1 w-full sm:flex-0 sm:w-[unset] rounded-md rounded-r-none !justify-between h-full"
          >
            <LinkInternal
              href={
        ...
        <div className='w-1/2 border-neubrutal rounded-lg h-20'>
          <Button
            ...
            variant="secondary"
            size="lg"
            className='px-6 font-display text-lg !font-bold !background-card rounded-md !justify-between h-full'
          >
